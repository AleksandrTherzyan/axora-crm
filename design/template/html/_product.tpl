{* не выводим див если на странице сравнения *}
{if !$is_compares}
<div class="{if $is_catalog}catalog__item{else}catalog-slider__item{/if}">
{/if}
            ...
            <div class="item__meta">
                <div class="meta">
                    <div class="meta__item">
                        {include file="_rating.tpl" is_product_card=true}
                    </div>
